<!--
	This page was created to proccess information from the Loginpur.php form.
	The page is identical to the Logininfo.php page but offers
	different navigation options and sends the user back to the basket page instead
	of the homepage.
-->
...
<?php
	...
	if($Check == 1) {
		...
		echo "<br />";
		echo "<a href=Basket.php>Return to Basket Page</a><br />";
		echo "<br />";
